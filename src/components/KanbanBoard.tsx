    ...
    <div className="space-y-6 h-full flex flex-col animate-fade-in">
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 overflow-hidden pb-4">
        {columns.map((col) => (
          <div
            key={col.id}
            className="bg-slate-100/50 rounded-[2rem] border border-slate-200 flex flex-col min-h-[600px] shadow-sm"
          >
                ...
                .map((task) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2 mt-2 pt-4 border-t border-slate-50">
                      <p className="w-full text-[9px] font-black text-slate-300 uppercase tracking-widest mb-1 ml-0.5">
                        Mover para:
                      </p>
                        ...
                        {columns
                          ...
                          .map((c) => (
                            <button
                              ...
                              className={`flex items-center justify-center gap-1.5 text-[10px] py-2 px-2 rounded-xl border font-bold transition-all active:scale-95 shadow-sm ${getMoveButtonStyle(
                                c.id,
                              )}`}
                            >
