...
import { Client, Appointment, FinancialRecord } from '../types/types';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
          <div className="flex justify-between items-start mb-4">
            ...
            <span className="text-xs font-bold text-green-500 bg-green-100 px-2 py-1 rounded-lg">
              +12%
            </span>
          </div>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
          <div className="flex justify-between items-start mb-4">
            ...
            <span className="text-xs font-bold text-teal-500 bg-teal-100 px-2 py-1 rounded-lg">
              Foco Mês
            </span>
          </div>
          <h3 className="text-slate-500 text-sm font-medium">
